...
if len(st.session_state.orders_chat) == 0:
    ...
    st.session_state.orders_chat.append(("assistant", intro))
...
if user_input:
    ...
    st.session_state.orders_chat.append(("user", user_input))
    ...
    if q in ["hi", "hello", "hey"]:
        ...
        st.session_state.orders_chat.append(("assistant", answer))
...
st.set_page_config(page_title="Delivery", page_icon="🚚")
...
st.set_page_config(page_title="Buy", page_icon="🛒")
...
question = st.chat_input("Ask Product Recommendation")
